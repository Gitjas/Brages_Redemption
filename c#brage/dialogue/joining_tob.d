...
BEGIN C#Brag25
IF ~Global("C#BrageSummoned","GLOBAL",1)~ THEN jointob
...
IF ~~ THEN joinbg2_01
SAY @25 /* ~Gladly.~ */
IF ~~ THEN DO ~SetGlobal("C#BrageSummoned","GLOBAL",5) SetGlobal("C#BE_BrageTalksToB","GLOBAL",1) RealSetGlobalTimer("C#BE_BrageDialogueTimer","GLOBAL",800) JoinParty()~ EXIT
END

IF ~~ THEN joinbg2_02
SAY ~Then I guess I will be waiting... over there.~
IF ~~ THEN DO ~SetGlobal("C#BrageSummoned","GLOBAL",4)
ActionOverride("C#Brage",MoveToPoint([1658.1168]))
ActionOverride("C#Brage",Face(0))~ EXIT
END

IF ~Global("C#BrageSummoned","GLOBAL",4)~ THEN joinbg2_07
