...
CHAIN 
IF WEIGHT #-1
~Global("C#BE_SpawnBrage","GLOBAL",2)~ THEN NALIN nudge
@0 DO ~SetGlobal("C#BE_SpawnBrage","GLOBAL",3)~
== BRAGE @1
== NALIN @2
== BRAGE @3
== NALIN @4
...
CHAIN 
IF WEIGHT #-1
~Global("C#BE_SpawnBrage","GLOBAL",3)~ THEN BRAGE join_request
@5
= @6 
== BRAGE @7
...
== NALIN @13
END
IF ~~ THEN DO ~SetGlobal("C#BE_SpawnBrage","GLOBAL",4) 
...
SAY @14
IF ~~ THEN DO ~SetGlobal("C#BE_SpawnBrage","GLOBAL",7)~ EXIT 
END
...
IF ~Global("C#BE_SpawnBrage","GLOBAL",7)~ THEN + joinlater
END
...
BEGIN C#Brage1
IF ~Global("C#BE_SpawnBrage","GLOBAL",5)~ THEN join
SAY @18 
IF ~~ THEN DO ~SetGlobal("C#BE_SpawnBrage","GLOBAL",6) SetGlobal("C#BE_BrageTalks","GLOBAL",1) RealSetGlobalTimer("C#BE_BrageDialogueTimer","GLOBAL",800) JoinParty()~ EXIT
END
